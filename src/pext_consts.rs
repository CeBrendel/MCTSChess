...
const fn inverse_pext(pext: usize, mask: Bitboard) -> Bitboard {
...
// will change to const later
pub static LOOKUP_PLUS_ATTACK_PEXT: [[Bitboard; 4096]; 64] = {
...
// will change to const later
pub static LOOKUP_X_ATTACK_PEXT: [[Bitboard; 512]; 64] = {
